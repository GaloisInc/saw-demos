...
Python implementation (under the `python/` directory). Note that at the moment, the Python
proofs cover more parts of `libsignal-protocol-c` than the SAWScript proofs do.
